...
void handleFileList(AsyncWebServerRequest *request) {
  ...
  outputHtml += "<h2>Actions</h2><a target=\"_blank\" href=\"/take\">Prendre une photo</a>&nbsp;<a target=\"\" href=\"/wifi\">Basculer forcage WiFi</a>&nbsp;<a onclick=\"addtimestamp()\" href=\"#\" id=\"timeLink\">R&eacute;gler l'heure</a>&nbsp;<a target=\"\" href=\"/format\">Formatter LittleFS + SD</a><br /><br />";
